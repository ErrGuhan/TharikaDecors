...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-[#FCFAF7] pb-28 sm:pb-20 overflow-hidden">
      ...
      <section className="relative w-full h-[340px] sm:h-[420px] md:h-[480px] overflow-hidden flex items-center justify-center">
        ...
        {/* Rich Dark Twilight Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#07192C]/80 via-[#0B2B4A]/50 to-[#07192C]/90 pointer-events-none" />
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/15 backdrop-blur-xl border border-[#E5B842]/50 text-[#FFF3C4] text-xs font-bold uppercase tracking-[0.2em] mb-4 shadow-lg"
          >
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        >
          <span className="inline-block text-xs font-extrabold uppercase tracking-[0.25em] text-[#0B2B4A]/75 mb-2">
            Our Heritage &amp; Roots
          </span>
          <h2 className="font-heading font-serif text-3xl sm:text-5xl font-bold text-[#0B2B4A]">
            Tradition Infused With Modern Grandeur
          </h2>

          {/* Elegant Gold Divider */}
          <div className="w-20 h-1 rounded-full bg-gradient-to-r from-transparent via-[#E5B842] to-transparent mx-auto my-6 opacity-90 shadow-sm" />

          <p className="text-base sm:text-lg text-[#0B2B4A]/85 leading-relaxed font-normal">
        ...
        >
          {stats.map(({ icon: Icon, label, sub }) => (
            <div
              key={label}
              className="liquid-glass-card flex flex-col items-center justify-center p-6 sm:p-7 rounded-3xl transition-all duration-300 hover:scale-[1.03] hover:border-[#E5B842]/60 group text-center"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#0B2B4A]/5 border border-[#E5B842]/35 text-[#E5B842] mb-3 group-hover:scale-110 group-hover:bg-[#0B2B4A] group-hover:text-white transition-all shadow-sm">
                <Icon className="h-6 w-6" />
              </div>
              <span className="font-heading font-serif text-2xl sm:text-3xl font-bold text-[#0B2B4A]">
                {label}
              </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-20">
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }}
            transition={{ duration: 0.6 }}
            className="liquid-glass-card p-8 sm:p-10 rounded-3xl flex flex-col justify-between hover:border-[#E5B842]/60 transition-all"
          >
            <div>
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#0B2B4A]/5 text-[#0B2B4A] text-xs font-extrabold uppercase tracking-wider mb-4 border border-[#0B2B4A]/12">
                <Compass className="w-4 h-4 text-[#E5B842]" />
                <span>Our Vision</span>
              </div>
              <h3 className="font-heading font-serif text-2xl sm:text-3xl font-bold text-[#0B2B4A] mb-3.5">
            ...
            <div className="mt-8 pt-4 border-t border-[#E5B842]/25 flex items-center gap-2 text-xs font-bold text-[#0B2B4A]">
          ...
          >
            ...
            <div className="mt-8 pt-4 border-t border-[#E5B842]/25 flex items-center gap-2 text-xs font-bold text-emerald-700">
        ...
        >
          <div className="text-center mb-12">
            <span className="text-xs font-extrabold uppercase tracking-[0.25em] text-[#0B2B4A]/60">
              The Tharika Signature
            </span>
            <h3 className="mt-2 font-heading font-serif text-3xl sm:text-4xl font-bold text-[#0B2B4A]">
              Why Families Trust Us
            </h3>
            <div className="w-16 h-1 rounded-full bg-[#E5B842] mx-auto mt-4 opacity-90 shadow-xs" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {pillars.map(({ icon: Icon, title, desc }) => (
              <div
                key={title}
                className="liquid-glass-card p-7 sm:p-8 rounded-3xl hover:border-[#E5B842]/60 hover:scale-[1.02] transition-all duration-300 group"
              >
                <div className="w-12 h-12 rounded-2xl bg-[#0B2B4A] text-[#E5B842] flex items-center justify-center mb-5 shadow-md group-hover:scale-110 transition-transform">
                  <Icon className="w-6 h-6" />
                </div>
                <h4 className="font-heading font-serif text-xl font-bold text-[#0B2B4A] mb-2.5">
                  {title}
                </h4>
        ...
        >
          <div
            className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-[#E5B842]/25 via-transparent to-transparent pointer-events-none"
            aria-hidden="true"
          />

          <div className="relative z-10 max-w-2xl mx-auto">
            <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-white/10 text-[#FFF3C4] text-xs font-bold uppercase tracking-widest border border-white/20 mb-5 shadow-sm">
              <Sparkles className="w-3.5 h-3.5 text-[#E5B842]" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/book"
                className="gold-shimmer w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-tharika-gold-gradient text-[#0B2B4A] font-extrabold text-sm uppercase tracking-wider shadow-[0_8px_25px_rgba(229,184,66,0.45)] hover:scale-105 active:scale-95 transition-all border border-white/50"
              >
